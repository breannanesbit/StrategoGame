...
import { GenericRadioInput, useCustomRadioControl } from "../component/GenericRadio";
...
const GameBoard: React.FC = () => {
  ...
  const SubmitDefaultBoard = (event: FormEvent<HTMLFormElement>): void => {
    ...
    const selectedBoardData = userBoards?.boards.find(board => board.title === selectedBoard);
